$(function() {
	...
	$(document).on("click", "#addBtn", function() {
			...
			str += '<div class="locationBtn_delBtn_wrap" style="display: flex;">'
				...
				+ '</div>'
				+ '</div>';
			str += "<input type='text' class='location location1' name='location' id='location"+postCnt+"'>";
			str += "<input type='text' class='location location2' name='location_addr' id='location_addr"+postCnt+"'></div>";
			str += "<hr><textarea name='content' id='content"+ postCnt+ "' placeholder='사진에 대해 설명해주세요.'></textarea>";
			str += "</div></div>";
